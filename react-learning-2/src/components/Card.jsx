...
function Card({ data, handleClick, index }) {
  ...
  return (
    <div className="w-60 bg-zinc-100 p-4 pb-8 rounded-md flex gap-4 relative mt-10">
      ...
      <button onClick={()=>handleClick(index)} className={`px-2 py-2 whitespace-nowrap ${added === false ? "bg-orange-600" : "bg-teal-500"} absolute bottom-0 left-1/2 -translate-x-[50%] translate-y-[50%] text-white text-xs rounded-full`}>
