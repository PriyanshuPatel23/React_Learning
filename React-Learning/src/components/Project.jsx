    ...
    <div className="w-full h-screen bg-zinc-300 flex justify-center items-center">
      <div className="relative w-60 h-32 bg-zinc-500 flex rounded overflow-hidden">
        <img
          ...
          className={`shrink-0 transition-all	 ease-in duration-300 ${val === false ? "-translate-x-[0%]" : "-translate-x-[100%]"} w-full h-full object-cover`}
          alt=""
        />
        <img
          ...
          alt=""
        />
        <span onClick={()=>setVal(()=>!val)} className="w-8 h-8 bg-blue-500 flex items-center justify-center rounded-full bg-[#dadada8b] absolute bottom-[7%] left-1/2 -translate-x-[50%]">
